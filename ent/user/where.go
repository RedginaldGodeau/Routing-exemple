...
// HasHorses applies the HasEdge predicate on the "horses" edge.
func HasHorses() predicate.User {
...
// HasHorsesWith applies the HasEdge predicate on the "horses" edge with a given conditions (other predicates).
func HasHorsesWith(preds ...predicate.Horse) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newHorsesStep()
